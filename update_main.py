...
#--------------------#
'''
    Description: the program will check if the file does not 
            exist and print Error. 
            The file 'questions.txt' does not exist.
'''
#--------------------#
# questions = []
# try:
...
#         for i in f:
#             questions.append(eval(i.strip()))
# except FileNotFoundError:
#     print("Error: The file 'questions.txt' does not exist.")
